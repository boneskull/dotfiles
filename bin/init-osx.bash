...
#sudo scutil --set ComputerName "lectroid"
#sudo scutil --set HostName "lectroid"
#sudo scutil --set LocalHostName "lectroid"
#sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "lectroid"
